...
layout=html.Div(
    children=[
        html.Div(
            id='div_cytoscape_to_species_cyto',
            children=[
                cyto.Cytoscape(
        ...
        html.Div(
            id='div_cytoscape_to_organ_cyto',
            children=[
                cyto.Cytoscape(
        ...
        html.Div(
            id='div_cytoscape_to_disease_cyto',
            children=[
                cyto.Cytoscape(
...
def callback_aggregate(
    ...
    if (len(callback_context.triggered)>1) and (store_to_species_data is None):
        ...
        for temp_checkbox in checklist_hashmap_species.keys():
            ...
            if all([(i in store_to_species_data['species']) for i in checklist_hashmap_species[temp_checkbox]]):
        ...
        if (len(store_to_species_data['checkboxes']) < len(checklist_to_species_value)):
            ...
            store_to_species_data['species']=list(set(store_to_species_data['species']).union(set(checklist_hashmap_species[box_we_clicked])))
            ...
            store_to_species_data['species']=list(set(store_to_species_data['species']).difference(set(checklist_hashmap_species[box_we_unclicked])))
        ...
        if len(store_to_species_data['species']) < len(dropdown_to_species_value):
            ...
            for temp_checkbox in checkboxes_to_which_this_species_belongs:
                ...
                if len(set(checklist_hashmap_species[temp_checkbox]).difference(set(dropdown_to_species_value)))==0:
...
def callback_aggregate(
    ...
    if (len(callback_context.triggered)>1) and (store_to_organ_data is None):
        ...
        for temp_checkbox in checklist_hashmap_organ.keys():
            #if every node id is in the store
            if all([(i in store_to_organ_data['organ']) for i in checklist_hashmap_organ[temp_checkbox]]):
                new_checkbox_values.append(temp_checkbox)
        ...
        if (len(store_to_organ_data['checkboxes']) < len(checklist_to_organ_value)):
            ...
            store_to_organ_data['organ']=list(set(store_to_organ_data['organ']).union(set(checklist_hashmap_organ[box_we_clicked])))
            ...
            store_to_organ_data['organ']=list(set(store_to_organ_data['organ']).difference(set(checklist_hashmap_organ[box_we_unclicked])))
        ...
        if len(store_to_organ_data['organ']) < len(dropdown_to_organ_value):
            ...
            for temp_checkbox in checkboxes_to_which_this_organ_belongs:
                ...
                if len(set(checklist_hashmap_organ[temp_checkbox]).difference(set(dropdown_to_organ_value)))==0:
...
def callback_aggregate(
    ...
    if (len(callback_context.triggered)>1) and (store_to_disease_data is None):
        ...
        for temp_checkbox in checklist_hashmap_disease.keys():
            #if every node id is in the store
            if all([(i in store_to_disease_data['disease']) for i in checklist_hashmap_disease[temp_checkbox]]):
                new_checkbox_values.append(temp_checkbox)
        ...
        if (len(store_to_disease_data['checkboxes']) < len(checklist_to_disease_value)):
            ...
            store_to_disease_data['disease']=list(set(store_to_disease_data['disease']).union(set(checklist_hashmap_disease[box_we_clicked])))
            ...
            store_to_disease_data['disease']=list(set(store_to_disease_data['disease']).difference(set(checklist_hashmap_disease[box_we_unclicked])))
        ...
        if len(store_to_disease_data['disease']) < len(dropdown_to_disease_value):
            ...
            for temp_checkbox in checkboxes_to_which_this_disease_belongs:
                ...
                if len(set(checklist_hashmap_disease[temp_checkbox]).difference(set(dropdown_to_disease_value)))==0:
